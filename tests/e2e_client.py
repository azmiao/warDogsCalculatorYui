...
# 待发送的测试消息序列
MESSAGES = [
    '火力计算 105 115 110 120',
    '火力计算 x97.43, y109.27 x100.5, y120.3',
    '火力计算 x97.43, y109.27, x100.5, y120.3',
    '火力计算 榴弹炮 100 100 115 120',
    '火力计算 105',
    # 炮位锁定流程
    '火力计算 锁定 105 115',
    '火力计算 110 120',          # 已锁定：单坐标即目标
    '火力计算 榴弹炮 110 120',    # 已锁定 + 指定武器
    '火力计算 锁定 x97.43, y109.27',  # 替换锁定
    '火力计算 锁定',              # 查看当前锁定
    '火力计算 解锁',
    '火力计算 110 120',          # 已解锁：应提示需要炮位
    '火力计算帮助',
]
